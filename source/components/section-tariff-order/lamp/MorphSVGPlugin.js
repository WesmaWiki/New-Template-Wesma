...
!(function (t, e) {
	...
	function convertToPath(t, e) {
		...
		return "path" !== T && t.getBBox
			? ((s = (function _createPath(t, e) {
			  ...
			  "rect" === T ? ((i = M.rx), (a = M.ry || i), (r = M.x), (o = M.y), (g = M.width - 2 * i), (f = M.height - 2 * a), (n = i || a ? "M" + (_ = (d = (u = r + i) + g) + i) + "," + (w = o + a) + " V" + (v = w + f) + " C" + [_, (y = v + a * b), (P = d + i * b), (x = v + a), d, x, d - (d - u) / 3, x, u + (d - u) / 3, x, u, x, (p = r + i * (1 - b)), x, r, y, r, v, r, v - (v - w) / 3, r, w + (v - w) / 3, r, w, r, (m = o + a * (1 - b)), p, o, u, o, u + (d - u) / 3, o, d - (d - u) / 3, o, d, o, P, o, _, m, _, w].join(",") + "z" : "M" + (r + g) + "," + o + " v" + f + " h" + -g + " v" + -f + " h" + g + "z")) : "circle" === T || "ellipse" === T ? ((l = "circle" === T ? (i = a = M.r) * b : ((i = M.rx), (a = M.ry) * b)), (n = "M" + ((r = M.cx) + i) + "," + (o = M.cy) + " C" + [r + i, o + l, r + (h = i * b), o + a, r, o + a, r - h, o + a, r - i, o + l, r - i, o, r - i, o - l, r - h, o - a, r, o - a, r + h, o - a, r + i, o - l, r + i, o].join(",") + "z")) : "line" === T ? (n = "M" + M.x1 + "," + M.y1 + " L" + M.x2 + "," + M.y2) : ("polyline" !== T && "polygon" !== T) || ((n = "M" + (r = (c = (t.getAttribute("points") + "").match(N) || []).shift()) + "," + (o = c.shift()) + " L" + c.join(",")), "polygon" === T && (n += "," + r + "," + o + "z")),
	...
	function aa(t, e) {
		var n,
			...
			_ = t.length,
			m = e / ((_ - 2) / 6);
		for (u = 2; u < _; u += 6) for (P += m; 0.999999 < P; ) (n = t[u - 2]), (r = t[u - 1]), (o = t[u]), (i = t[u + 1]), (a = t[u + 2]), (s = t[u + 3]), (h = t[u + 4]), (l = t[u + 5]), (c = n + (o - n) * (d = 1 / ((Math.floor(P) || 1) + 1))), (c += ((f = o + (a - o) * d) - c) * d), (f += (a + (h - a) * d - f) * d), (g = r + (i - r) * d), (g += ((p = i + (s - i) * d) - g) * d), (p += (s + (l - s) * d - p) * d), t.splice(u, 4, n + (o - n) * d, r + (i - r) * d, c, g, c + (f - c) * d, g + (p - g) * d, f, p, a + (h - a) * d, s + (l - s) * d), (u += 6), (_ += 6), P--;
		return t;
	}
	...
	function ea(t, e) {
		...
		for (n = (0.5 * e) / (0.5 * (o = t.length) - 1), r = 0; r < o - 2; r += 2) {
			if (((l += n), (s = parseFloat(t[r + 2])), (h = parseFloat(t[r + 3])), 0.999999 < l)) for (a = 1 / (Math.floor(l) + 1), i = 1; 0.999999 < l; ) (f += (c + (s - c) * a * i).toFixed(2) + "," + (g + (h - g) * a * i).toFixed(2) + " "), l--, i++;
			(f += s + "," + h + " "), (c = s), (g = h);
		}
		return f;
	}
	...
	function ja(t) {
		var e = t.trim().split(" ");
		return { x: (~t.indexOf("left") ? 0 : ~t.indexOf("right") ? 100 : isNaN(parseFloat(e[0])) ? 50 : parseFloat(e[0])) / 100, y: (~t.indexOf("top") ? 0 : ~t.indexOf("bottom") ? 100 : isNaN(parseFloat(e[1])) ? 50 : parseFloat(e[1])) / 100 };
	}
	function ma(t, e, n, r) {
		var o,
			i,
		...
		K = {
			...
			init: function init(t, e, n, r, o) {
				...
				if (((c = e.shapeIndex || 0 === e.shapeIndex ? e.shapeIndex : "auto"), (g = e.map || K.defaultMap), (this._prop = e.prop), (this._render = e.render || K.defaultRender), (this._apply = "updateTarget" in e ? e.updateTarget : K.defaultUpdateTarget), (this._rnd = Math.pow(10, isNaN(e.precision) ? 2 : +e.precision)), (this._tween = n), h)) {
					if (((this._target = t), (y = "object" == typeof e.precompile), (u = this._prop ? t[this._prop] : t.getAttribute(a)), this._prop || t.getAttributeNS(null, "data-original") || t.setAttributeNS(null, "data-original", u), "d" === a || this._prop)) {
						...
						for (("log" !== e.precompile && !0 !== e.precompile) || M('precompile:["' + rawPathToString(u) + '","' + rawPathToString(d) + '"]'), (S = "linear" !== (e.type || K.defaultType)) && ((u = ia(u, e.smoothTolerance)), (d = ia(d, e.smoothTolerance)), u.size || U(u), d.size || U(d), (b = ja(C[0])), (this._origin = u.origin = { x: u.left + b.x * u.width, y: u.top + b.y * u.height }), C[1] && (b = ja(C[1])), (this._eOrigin = { x: d.left + b.x * d.width, y: d.top + b.y * d.height })), this._rawPath = t._gsRawPath = u, _ = u.length; -1 < --_; ) for (w = u[_], v = d[_], f = w.isSmooth || [], p = v.isSmooth || [], m = w.length, P = I = 0; P < m; P += 2) (v[P] === w[P] && v[P + 1] === w[P + 1]) || (S ? (f[P] && p[P] ? ((x = w.smoothData), (T = v.smoothData), (N = P + (P === m - 4 ? 7 - m : 5)), (this._controlPT = { _next: this._controlPT, i: P, j: _, l1s: x[P + 1], l1c: T[P + 1] - x[P + 1], l2s: x[N], l2c: T[N] - x[N] }), (s = this._tweenRotation(w, v, P + 2)), this._tweenRotation(w, v, P, s), this._tweenRotation(w, v, N - 1, s), (P += 4)) : this._tweenRotation(w, v, P)) : ((s = this.add(w, P, w[P], v[P])), (s = this.add(w, P + 1, w[P + 1], v[P + 1]) || s)));
			...
			render: function render(t, e) {
				...
				if (1 === t && e._apply) for (w = e._pt; w; ) w.end && (e._prop ? (m[e._prop] = w.end) : m.setAttribute(w.endProp, w.end)), (w = w._next);
					...
					for (r = t < 0.5 ? 2 * t * t : (4 - 2 * t) * t - 1; d; ) (p = (s = d.i) + (s === (o = u[d.j]).length - 4 ? 7 - o.length : 5)), (a = v(o[p] - o[s + 1], o[p - 1] - o[s])), (g = O(a)), (f = x(a)), (l = o[s + 2]), (c = o[s + 3]), (i = d.l1s + r * d.l1c), (o[s] = l - f * i), (o[s + 1] = c - g * i), (i = d.l2s + r * d.l2c), (o[p - 1] = l + f * i), (o[p] = c + g * i), (d = d._next);
