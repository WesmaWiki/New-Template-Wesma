...
function init() {
	...
	window.addEventListener("resize", () => {
		...
		renderer.setSize(document.querySelector(".main-screen-support__group-anim") ? document.querySelector(".main-screen-support__group-anim").clientWidth : 0, document.querySelector(".main-screen-support__group-anim") ? document.querySelector(".main-screen-support__group-anim").clientHeight : 0);
	});
...
function objects() {
	 ...
	 */
	const sizes = {
		width: document.querySelector(".main-screen-support__group-anim") ? document.querySelector(".main-screen-support__group-anim").clientWidth : 0,
		height: document.querySelector(".main-screen-support__group-anim") ? document.querySelector(".main-screen-support__group-anim").clientHeight : 0,
	};

	window.addEventListener("resize", () => {
		// Update sizes
		sizes.width = document.querySelector(".main-screen-support__group-anim") ? document.querySelector(".main-screen-support__group-anim").clientWidth : 0;
		sizes.height = document.querySelector(".main-screen-support__group-anim") ? document.querySelector(".main-screen-support__group-anim").clientHeight : 0;
